...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: "ruang-publik/download", 
        component: RuangDownloadView, 
      },
      {
        path: "/ruang-publik/download-regulasi",
        name: "DownloadRegulasi",
        component: RuangDownloadRegulasiView, 
      },
      {
        path: "/ruang-publik/download-sptjm",
        name: "DownloadSPTJM",
        component: RuangDownloadSPTJMView,
      },
      {
        path: "/ruang-publik/download-formulir-persyaratan",
        name: "DownloadFormulir",
        component: RuangDownloadFormulirView, 
      },
      {
        path: "/ruang-publik/download-formulir-pengajuan",
        name: "DownloadPengajuan",
        component: RuangDownloadPengajuanView, 
      },

      //Ruang Publik - Buku Tamu
      {
        path: "/ruang-publik/buku-tamu",
        component: RuangBukuTamuView, 
      },
      {
      ...
      //Ruang Publik - Galeri
      {
        path: "ruang-publik/galeri", 
        component: RuangGaleriView, 
      },
      {
      ...
      {
        path: "berita/berita-disdukcapil", 
        component: BeritaBeritaView, 
      },
      {
      ...
      {
        path: "berita/kamus-adminduk", 
        component: BeritaKamusView, 
      },
      {
