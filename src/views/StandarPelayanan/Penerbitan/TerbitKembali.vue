<template>
    <h1>REGISTER DAN AKTA PENCATATAN SIPIL</h1>
    <div class="profil-visi-misi">
      ...
      <section class="menu-grid">
        <div class="menu-column">
          <div class="menu-item">
            <ol>
              <p><b> PENERBITAN KEMBALI REGISTER DAN AKTA PENCATATAN SIPIL</b> </p>
            ...
            <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; margin-top: 20px; border-collapse: collapse; text-align: left;">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <ol>
                        <li>Surat keterangan hilang dari kepolisian; atau</li>
                        <li>Kutipan akta pencatatn sipil yang rusak; atau</li>
                        <li>Surat pernyataan kutipan akta pencatatan sipil dalam penguasaan
                            salah satu pihak yang bersengketa
                        </li>
                        <li>Kartu Keluarga; dan</li>
                        <li>KTP-El</li>
                    </ol>
                  </td>
                  <td></td>
                  ...
                  <td>
                    <ol>
                        ...
                        <li>Petugas Pelayanan Melakukan Verifikasi dan Validasi 
                            terhadap Formulir dan Persyaratan</li>
                        <li>Petugas Melakukan Perekaman Data ke dalam Database Kependudukan</li>
                        <li>Pejabat Pencatatan Sipil menerbitkan kembali Register
                            akta pencatatan sipil dan kutipan akta pencatatan dan disampaikan kepada Pemohon
                        </li>
                    </ol>
                  </td>
                  <td></td>
