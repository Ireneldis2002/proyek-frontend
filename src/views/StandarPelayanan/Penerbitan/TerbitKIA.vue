              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <ol>
                      <li>
                        Berumur kurang 17 (tujuh belas) tahun dan belum kawin;
                      </li>
                      <li>Kutipan Akta Kelahiran;</li>
                      <li>Kartu Keluarga;</li>
                      <li>
                        Pas Photo ukuran 3x4 bagi anak usia 5 tahun s/d kurang
                        17 (tujuh belas) tahun dengan latar merah untuk tahun
                        kelahiran ganjil dan latar biru untuk tahun kelahiran
                        genap;
                      </li>
                      <li>
                ...
                <tr>
                  ...
                  <td>
                    <ol>
                      ...
                      <li>
                        Petugas pelayanan melakukan input data dan scan Pas
                        Photo ke dalam aplikasi SIAK
                      </li>
