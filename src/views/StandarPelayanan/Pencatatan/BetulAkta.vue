            ...
            <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; margin-top: 20px; border-collapse: collapse; text-align: left;">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <ol>
                        <li>Dokumen autentik yang menjadi persyaratan   pembuatan akta pencatatan   sipil;   dan</li>
                        <li>Kutipan akta Pencatatan Sipil dimana terdapat   kesalahan tulis redaksional.</li>                   
                    </ol>
                  </td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <td>
                    <ol>
                        ...
                        <li>Petugas pelayanan   melakukan verifikasi dan validasi   terhadap formulir dan persyaratan;</li>
                        <li>Petugas Melakukan Perekaman Data ke dalam Database Kependudukan</li>
                        <li>Pejabat Pencatatan Sipil memberikan catatan pinggir     pada register akta pencatatan sipil mengenai   pembetulan akta pencatatan sipil;</li>
                        <li>Pejabat Pencatatan Sipil menerbitkan kembali   kutipan   akta pencatatan sipil dan mencabut kutipan akta     pencatatan sipil dari subjek akta; dan</li>
                        <li>Kutipan akta pencatatan sipil yang telah dibetulkan   diserahkan kepada Pemohon.</li>
                    </ol>
                  </td>
                  <td></td>
                </tr>
