              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <ol type="a">
                      <li>
                        Pencatatan Biodata Kependudukan WNI di wilayah NKRI
                      </li>
                      <ol>
                      ...
                      <li>
                        Pencatatan Biodata Kependudukan WNI yang Datang dari
                        luar wilayah NKRI
                      </li>
                      <ol>
                      ...
                      <li>
                        Pencatatan Biodata Kependudukan Penduduk Orang Asing
                        yang memiliki izin tinggal terbatas atau Orang Asing
                ...
                <tr>
                  ...
                  <td>
                    <ol>
                      ...
                      <li>
                        Petugas pada Dinas Dukcapil mencetak biodata Penduduk
                        apabila dimintakan oleh Pemohon;
                      </li>
                      <li>
                        Kepala Dinas menerbitkan dan menandatangani biodata
                        Penduduk;dan
                      </li>
                      <li>
                        Biodata Penduduk yang telah diterbitkan dan
