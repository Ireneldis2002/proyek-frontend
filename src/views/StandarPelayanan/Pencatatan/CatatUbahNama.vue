<template>
    ...
    <div class="profil-visi-misi">
      ...
      <section class="menu-grid">
        <div class="menu-column">
          <div class="menu-item">
            <ol>
              <p><b>PENCATATAN PERUBAHAN NAMA ANAK (ANAK ANGKAT)</b> </p>
                ...
                <tr>
                  ...
                  <td>
                    <ol>
                        ...
                        <li>Pejabat Pencatatan Sipil memberikan catatan pinggir pada register kutipan akta pencatatan sipil; dan</li>
                        <li>Kutipan akta pencatatan sipil yang telah diberikan catatan pinggir disampaikan kepada Pemohon</li>
                    </ol>
                  </td>
                  <td></td>
                </tr>
  ...
  <script>
  export default {
    name: 'PencatatanUbahNamaAnakView',
    data() {
      return {
