    ...
    <div class="profil-visi-misi">
      ...
      <section class="menu-grid">
        <div class="menu-column">
          <div class="menu-item">
            <ol>
              <p><b>PENCATATAN PERISTIWA PENTING LAINNYA</b> </p>
                ...
                <tr>
                  ...
                  <td>
                    <ol>
                        ...
                        <li>Kutipan akta pencatatan sipil;</li>
                        <li>Kartu Keluarga;</li>
                        <li>KTP-el;</li>
                        <li>Dokumen Perjalanan bagi Orang Asing</li>                   
                    </ol>
                  </td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <td>
                    <ol>
                        ...
                        <li>Pejabat Pencatatan Sipil memberikan catatan pinggir pada register kutipan akta pencatatan sipil dan kutipan akta pencatatan sipil; dan</li>
                        <li>Kutipan akta pencatatan sipil yang telah diberika catatan pinggir disampaikan kepada Pemohon.</li>
                    </ol>
                  </td>
                  <td></td>
                </tr>
