            ...
            <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; margin-top: 20px; border-collapse: collapse; text-align: left;">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <p><b>Pencatatan Kematian di wilayah NKRI memenuhi persyaratan :</b></p>
                    <ol>
                        <li>Mengisi Formulir Pelaporan Kelahiran (F2.2.29)</li>
                        <li>Foto copy Surat Keterangan Kematian dari Rumah Sakit Kelurahan/Desa</li>
                        <li>Foto copy Kartu Keluarga yang bersangkutan</li>
                        <li>Foto copy KTP el yang bersangkutan</li>
                        <li>Foto copy KTP elektronik Saksi dan Pelapor</li>
                    </ol>
                    <br/>
                    <p><b>Pencatatan Kematian di luar Wilayah NKRI dengan memenuhi persyaratan :</b></p>
                    <ol>
                        <li>Kutipan akta kematian/bukti pencatatan kemarian dad setempat</li>
                        <li>Dokumen Perjalanan RI</li>
                        <li>Surat keterangan yang menunjukkan domisili atau keterangan pindah luar negeri</li>
                    </ol>
                  </td>
                  <td></td>
                </tr>
