              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <p>
                      <b
                        >Pencatatan Kematian di wilayah NKRI memenuhi
                        persyaratan :</b
                      >
                    </p>
                    <ol>
                      ...
                      <li>
                        Foto copy Surat Keterangan Kematian dari Rumah Sakit
                        Kelurahan/Desa
                      </li>
                    ...
                    <p>
                      <b
                        >Pencatatan Kematian di luar Wilayah NKRI dengan
                        memenuhi persyaratan :</b
                      >
                    </p>
                    <ol>
                      <li>
                        Kutipan akta kematian/bukti pencatatan kemarian dad
                        setempat
                      </li>
                      <li>Dokumen Perjalanan RI</li>
                      <li>
                        Surat keterangan yang menunjukkan domisili atau
