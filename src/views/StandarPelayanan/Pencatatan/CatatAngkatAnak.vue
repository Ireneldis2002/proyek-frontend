    ...
    <div class="profil-visi-misi">
      ...
      <section class="menu-grid">
        <div class="menu-column">
          <div class="menu-item">
            <ol>
              <p><b>PENCATATAN PENGANGKATAN ANAK</b> </p>
            ...
            <table border="1" cellpadding="10" cellspacing="0" style="width: 100%; margin-top: 20px; border-collapse: collapse; text-align: left;">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Pencatatan Pengangkatan Anak</td>
                  <td></td>
                </tr>
                <tr>
                  <td>2.</td>
                  ...
                  <td>
                    <ol>
                        <li>Salinan penetapan pengadilan</li>
                        <li>Kutipan akta kelahiran anak </li>
                        <li>Kartu Keluarga orang tua angkat</li>
                        <li>Ktp-el atau</li>
                        <li>Dokumen Perjalanan bagi Orang tua angkat Orang Asing</li>
                    </ol>
                  </td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <td>
                    <ol>
                        ...
                        <li>Pejabat Pencatatan Sipil memberikan catatan pinggir pada register akta kelahiran dan kutipan akta kelahiran</li>
                        <li>Pejabat Pencatatan Sipil menyerahkan Kutipan akta   kelahiran yang telah diberikan catatan pinggir kepada Pemohon.</li>
                    </ol>
                  </td>
                  <td></td>
                </tr>
                ...
                <tr>
                  ...
                  <td>Kutipan Akta Kelahiran yang telah Diberikan Catatan Pinggir</td>
                  <td></td>
                </tr>
                <tr>
                  <td>7.</td>
