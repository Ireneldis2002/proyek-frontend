<template>
  <div class="data-penduduk">
      ...
      <div class="content-section">
        <div class="menu-column">
          <div class="menu-item">
            <p>
              <b>
                Jumlah Penduduk Berdasarkan Data Konsolidasi Bersih (DKB)
                Semester I</b
              >
            </p>
    ...
    <p class="sumber">Sumber : Data Konsolidasi Bersih Semester I Tahun 2022</p>
  </div>
</template>

<script>
export default {
  name: "DataJumlahPendudukView",
};
</script>
