<template>
  <div class="ruang-download">
    ...
    <header>
      <h1>[Album] Jemput Bola Kecamatan Kotabaru</h1>
    </header>
...
export default {
  ...
  data() {
    return {
      fotoAlbum: [
        { src: require("@/assets/JemputBola1.jpg"), title: "Layanan Jemput Bola Kec. Kota Baru 1" },
        { src: require("@/assets/JemputBola2.jpg"), title: "Layanan Jemput Bola Kec. Kota Baru 2" },
        { src: require("@/assets/JemputBola3.jpg"), title: "Layanan Jemput Bola Kec. Kota Baru 3" },
        { src: require("@/assets/JemputBola4.jpg"), title: "Layanan Jemput Bola Kec. Kota Baru 4" },
        { src: require("@/assets/JemputBola5.jpg"), title: "Layanan Jemput Bola Kec. Kota Baru 5" },
        { src: require("@/assets/JemputBola6.jpg"), title: "Layanan Jemput Bola Kec. Kota Baru 6" },
        { src: require("@/assets/JemputBola7.jpg"), title: "Layanan Jemput Bola Kec. Kota Baru 7" },
      ],
      videoAlbum: [
        {
          thumbnail: require("@/assets/JemputBola1.jpg"),
          title: "Proses LayananJemput Bola Kec. Kota Baru",
