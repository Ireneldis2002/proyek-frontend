        ...
        <form>
          ...
          <div class="form-grid">
            <div class="input-container">
              <label
                >Surat Permandian/Surat Kelahiran dari Dokter/Bidan/Rumah
                Sakit/Puseksmas</label
              >
              <div
                class="upload-box"
                @click="triggerFileInput('fileSuratKelahiran')"
              ></div>
              <input
                type="file"
                ref="fileSuratKelahiran"
                class="hidden-file-input"
                @change="handleFileUpload($event, 'fileSuratKelahiran')"
              />
              <p v-if="uploadedFiles.fileSuratKelahiran" class="file-name">
                {{ uploadedFiles.fileSuratKelahiran.name }}
              </p>
              <p class="help-text">
                *Catatan : Jika tidak ada silahkan upload SPTJM kebenaran
                kelahiran
              </p>
            </div>
            ...
            <div class="input-container">
              <label
                ...
                <br />
                <i
                  >(Silahkan download format SPTJM kebenaran kelahiran di link
                  ini https://bit.ly/3vofqSc )</i
                >
              </label>
              <div
                class="upload-box"
                @click="triggerFileInput('fileSPTJM')"
              ></div>
              <input
                type="file"
                ref="fileSPTJM"
                class="hidden-file-input"
                @change="handleFileUpload($event, 'fileSPTJM')"
              />
              <p v-if="uploadedFiles.fileSPTJM" class="file-name">
                {{ uploadedFiles.fileSPTJM.name }}
              </p>
              <p class="help-text">
                *Catatan : Jika tidak memiliki surat keterangan kelahiran dari
                Dokter/Bidan/Rumah Sakit/Puskesmas maka WAJIB mengisi SPTJM
            ...
            <div class="input-container">
              ...
              <p class="help-text">
                *Catatan : Jika belum memiliki KTP-el tidak perlu di upload
              </p>
            </div>

            <div class="input-container">
              <label
                >SURAT PERNYATAAN TANGGUNG JAWAB MUTLAK (SPTJM) PASANGAN SUAMI
                ISTRI
                <br />
                <i
                  >(Silahkan download format SPTJM kebenaran pernikahan di link
                  ini https://bit.ly/2RH4y36 )</i
                >
              </label>
              <div
                class="upload-box"
                @click="triggerFileInput('fileAktaNikah')"
              ></div>
              <input
                type="file"
                ref="fileAktaNikah"
                class="hidden-file-input"
                @change="handleFileUpload($event, 'fileAktaNikah')"
              />
              <p v-if="uploadedFiles.fileAktaNikah" class="file-name">
                {{ uploadedFiles.fileAktaNikah.name }}
              </p>
              <p class="help-text">
                *Catatan : Jika tidak memiliki buku nikah/akta nikah, WAJIB
                mengisi SPTJM Kebenaran sebagai Pasangan Suami Istri yang telah
            ...
            <div class="input-container">
              ...
              <div
                class="upload-box"
                @click="triggerFileInput('fileBukuNikah')"
              ></div>
              <input
                type="file"
                ref="fileBukuNikah"
                class="hidden-file-input"
                @change="handleFileUpload($event, 'fileBukuNikah')"
              />
              <p v-if="uploadedFiles.fileBukuNikah" class="file-name">
                {{ uploadedFiles.fileBukuNikah.name }}
              </p>
              <p class="help-text">
                *Catatan : Jika tidak ada silahkan upload SPTJM kebenaran
                kelahiran atau surat keterangan belum menikah dari
                Desa/Kelurahan
              </p>
            </div>
            ...
            <div class="input-container">
              ...
              <p class="help-text">
                *Catatan : Dalam hal persyaratan berupa Akta Nikah/Kutipan Akta
                Perkawinan belum dimiliki/tidak terpenuhi oleh pasangan, pemohon
                WAJIB melampirkan surat keterangan belum menikah dari
                Desa/Kelurahan
              </p>
            </div>
